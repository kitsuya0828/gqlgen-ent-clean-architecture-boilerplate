...
func (uc *UserCreate) AddChildIDs(ids ...ulid.ID) *UserCreate {
...
func (uc *UserCreate) SetParentID(id ulid.ID) *UserCreate {
...
func (uc *UserCreate) SetNillableParentID(id *ulid.ID) *UserCreate {
	if id != nil {
